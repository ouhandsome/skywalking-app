F:\Software\SkyWalking\skywalking-agent

# Skywalking JAVA 应用和MySQL数据库，Mysql SQL 完整输出
...
-javaagent:/data/www/ad-server/skywalking-agent/skywalking-agent.jar

## 服务名称

-Dskywalking.agent.service_name=dev::xm-app-ds

## 示例名称

-Dskywalking.agent.instance_name=app-dev-1

## skywalking服务的端口

-Dskywalking.collector.backend_service=172.20.0.191:11800
...
public class FullSQLInterceptor implements Interceptor {
    ...
    static final Logger logger = LoggerFactory.getLogger(FullSQLInterceptor.class);
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        try {
            ...
            if (invocation.getArgs().length > 1) {
                ...
                logger.info("sql param:{}", parameter);
            }
